...
// ✅ src/app/salon/[salonId]/page.tsx
'use client';
import HeroSection from '@/components/HeroSection';
import ServicesSection from '@/components/ServicesSection';
import WorkingHours from '@/components/WorkingHours';
...
export default function SalonPage() {
  ...
  const transformedServices = salon.services.map((s) => ({
    ...
    title: s.serviceName,
    // description: '',
    description: s.serviceInfo, // serviceInfo-г description руу оруулж өгөх
    details: s.serviceInfo,
    price: s.servicePrice.toLocaleString() + '₮',
    duration: s.serviceTime + ' мин',
    serviceName: s.serviceName, // serviceName талбарыг нэмж өгөх
  }));
  ...
  return (
    <div className="font-sans">
      ...
      <div className="mt-10 px-4">
        <ProfileForm services={transformedServices} />
      </div>
    </div>
  );
}
